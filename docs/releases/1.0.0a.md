...
| `explore()` | `DataGranule`, `DataCollection`, `SearchResults` | Display interactive map |
...
See [CHANGELOG.md](https://github.com/earthaccess-dev/earthaccess/blob/main/CHANGELOG.md) for the complete list of changes.
