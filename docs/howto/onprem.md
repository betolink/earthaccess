...
In this example, granules are downloaded to the current working directory using the `path` keyword.  This can be changed to your preferred download location.
